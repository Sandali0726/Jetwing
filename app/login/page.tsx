    ...
    >
      <div className="w-full max-w-sm">
        <div className="flex items-center gap-3 justify-center mb-8">
          <img src="/jetwing-logo.png" alt="Jetwing" className="w-9 h-9" />
          <span
        ...
        <p className="text-center text-[11px] mt-5" style={{ color: C.muted }}>
          New here? After your first sign-in, call{" "}
          <code>POST /api/v1/admin/bootstrap</code> to claim the first ADMIN
          role.
        </p>
      </div>
    </div>
